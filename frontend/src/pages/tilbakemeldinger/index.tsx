import { Heading, Box, Text, SimpleGrid, GridItem, Divider, Spacer, Flex, Icon, Link } from '@chakra-ui/react';
...
import { MdAlignHorizontalCenter, MdAllInbox } from 'react-icons/md';
