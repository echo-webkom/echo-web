...
object WaitingListUUID : Table("waiting_list_uuid") {
    ...
    val lastNotified: Column<DateTime> =
        datetime(
            "last_notified",
        ).default(DateTime(0)) // default value is January 1st, 1970 (1970-01-01T01:00:00.000+01:00)
...
suspend fun notifyWaitinglistPerson(
    slug: String,
    email: String,
